  ...
  13              		.file	"stm32g4xx_ll_crc.c"
  14              		.text
  15              	.Ltext0:
  16              		.cfi_sections	.debug_frame
  17              		.section	.text.LL_CRC_DeInit,"ax",%progbits
  18              		.align	1
  19              		.global	LL_CRC_DeInit
  20              		.arch armv7e-m
  21              		.syntax unified
  22              		.thumb
  23              		.thumb_func
  ...
  27              	.LVL0:
  28              	.LFB192:
  29              		.file 1 "../../..\\CubeG4\\src\\stm32g4xx_ll_crc.c"
   1:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** /**
   2:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   ******************************************************************************
   3:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   * @file    stm32g4xx_ll_crc.c
   4:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   * @author  MCD Application Team
   5:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   * @brief   CRC LL module driver.
   6:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   ******************************************************************************
   7:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   * @attention
   8:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   *
   9:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   * <h2><center>&copy; Copyright (c) 2019 STMicroelectronics.
  10:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   * All rights reserved.</center></h2>
  11:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   *
  12:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   * This software component is licensed by ST under BSD 3-Clause license,
  13:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   * the "License"; You may not use this file except in compliance with the
  14:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   * License. You may obtain a copy of the License at:
  15:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   *                        opensource.org/licenses/BSD-3-Clause
  16:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   *
  17:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   ******************************************************************************
  18:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   */
  19:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** #if defined(USE_FULL_LL_DRIVER)
  20:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** 
  21:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** /* Includes ------------------------------------------------------------------*/
  22:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** #include "stm32g4xx_ll_crc.h"
  23:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** #include "stm32g4xx_ll_bus.h"
  24:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** 
  25:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** #ifdef  USE_FULL_ASSERT
  26:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** #include "stm32_assert.h"
  27:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** #else
  28:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** #define assert_param(expr) ((void)0U)
  29:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** #endif
  30:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** 
  31:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** /** @addtogroup STM32G4xx_LL_Driver
  32:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   * @{
  33:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   */
  34:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** 
  35:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** #if defined (CRC)
  36:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** 
  37:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** /** @addtogroup CRC_LL
  38:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   * @{
  39:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   */
  40:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** 
  41:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** /* Private types -------------------------------------------------------------*/
  42:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** /* Private variables ---------------------------------------------------------*/
  43:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** /* Private constants ---------------------------------------------------------*/
  44:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** /* Private macros ------------------------------------------------------------*/
  45:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** /* Private function prototypes -----------------------------------------------*/
  46:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** 
  47:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** /* Exported functions --------------------------------------------------------*/
  48:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** /** @addtogroup CRC_LL_Exported_Functions
  49:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   * @{
  50:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   */
  51:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** 
  52:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** /** @addtogroup CRC_LL_EF_Init
  53:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   * @{
  54:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   */
  55:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** 
  56:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** /**
  57:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   * @brief  De-initialize CRC registers (Registers restored to their default values).
  58:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   * @param  CRCx CRC Instance
  59:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   * @retval An ErrorStatus enumeration value:
  60:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   *          - SUCCESS: CRC registers are de-initialized
  61:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   *          - ERROR: CRC registers are not de-initialized
  62:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   */
  63:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** ErrorStatus LL_CRC_DeInit(CRC_TypeDef *CRCx)
  64:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** {
  30              		.loc 1 64 1 view -0
  31              		.cfi_startproc
  32              		@ args = 0, pretend = 0, frame = 0
  33              		@ frame_needed = 0, uses_anonymous_args = 0
  34              		@ link register save eliminated.
  65:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   ErrorStatus status = SUCCESS;
  35              		.loc 1 65 3 view .LVU1
  66:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** 
  67:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   /* Check the parameters */
  68:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   assert_param(IS_CRC_ALL_INSTANCE(CRCx));
  36              		.loc 1 68 3 view .LVU2
  69:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** 
  70:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   if (CRCx == CRC)
  37              		.loc 1 70 3 view .LVU3
  38              		.loc 1 70 6 is_stmt 0 view .LVU4
  39 0000 084B     		ldr	r3, .L4
  40 0002 9842     		cmp	r0, r3
  41 0004 0BD1     		bne	.L3
  71:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   {
  72:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****     /* Force CRC reset */
  73:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****     LL_AHB1_GRP1_ForceReset(LL_AHB1_GRP1_PERIPH_CRC);
  42              		.loc 1 73 5 is_stmt 1 view .LVU5
  43              	.LBB6:
  44              	.LBI6:
 ...
 324:../../..\CubeG4\include/stm32g4xx_ll_bus.h ****   SET_BIT(RCC->AHB1RSTR, Periphs);
  ...
  50 0006 A3F50053 		sub	r3, r3, #8192
  51              	.LBE7:
  52              	.LBE6:
  65:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** 
  53              		.loc 1 65 15 is_stmt 0 view .LVU8
  54 000a 0020     		movs	r0, #0
  55              	.LVL2:
  56              	.LBB9:
  57              	.LBB8:
  58              		.loc 2 324 3 view .LVU9
  59 000c 9A6A     		ldr	r2, [r3, #40]
  60 000e 42F48052 		orr	r2, r2, #4096
  61 0012 9A62     		str	r2, [r3, #40]
  62              	.LVL3:
  63              		.loc 2 324 3 view .LVU10
  64              	.LBE8:
  65              	.LBE9:
  74:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** 
  75:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****     /* Release CRC reset */
  76:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****     LL_AHB1_GRP1_ReleaseReset(LL_AHB1_GRP1_PERIPH_CRC);
  66              		.loc 1 76 5 is_stmt 1 view .LVU11
  67              	.LBB10:
  68              	.LBI10:
 ...
 347:../../..\CubeG4\include/stm32g4xx_ll_bus.h **** __STATIC_INLINE void LL_AHB1_GRP1_ReleaseReset(uint32_t Periphs)
  69              		.loc 2 347 22 view .LVU12
  70              	.LBB11:
 348:../../..\CubeG4\include/stm32g4xx_ll_bus.h **** {
 349:../../..\CubeG4\include/stm32g4xx_ll_bus.h ****   CLEAR_BIT(RCC->AHB1RSTR, Periphs);
  71              		.loc 2 349 3 view .LVU13
  72 0014 9A6A     		ldr	r2, [r3, #40]
  73 0016 22F48052 		bic	r2, r2, #4096
  74 001a 9A62     		str	r2, [r3, #40]
  75 001c 7047     		bx	lr
  76              	.LVL4:
  77              	.L3:
  78              		.loc 2 349 3 is_stmt 0 view .LVU14
  79              	.LBE11:
  80              	.LBE10:
  77:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   }
  78:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   else
  79:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   {
  80:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****     status = ERROR;
  81              		.loc 1 80 12 view .LVU15
  82 001e 0120     		movs	r0, #1
  83              	.LVL5:
  81:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   }
  82:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** 
  83:../../..\CubeG4\src/stm32g4xx_ll_crc.c ****   return (status);
  84              		.loc 1 83 3 is_stmt 1 view .LVU16
  84:../../..\CubeG4\src/stm32g4xx_ll_crc.c **** }
  85              		.loc 1 84 1 is_stmt 0 view .LVU17
  86 0020 7047     		bx	lr
  87              	.L5:
  88 0022 00BF     		.align	2
  89              	.L4:
  90 0024 00300240 		.word	1073885184
  91              		.cfi_endproc
  92              	.LFE192:
  94              		.text
  95              	.Letext0:
  96              		.file 3 "c:\\program files (x86)\\gnu tools arm embedded\\8 2018-q4-major\\arm-none-eabi\\include\
  97              		.file 4 "c:\\program files (x86)\\gnu tools arm embedded\\8 2018-q4-major\\arm-none-eabi\\include\
  98              		.file 5 "../../..\\CubeG4\\include/core_cm4.h"
  99              		.file 6 "../../..\\CubeG4\\include/system_stm32g4xx.h"
 100              		.file 7 "../../..\\CubeG4\\include/stm32g431xx.h"
 101              		.file 8 "../../..\\CubeG4\\include/stm32g4xx.h"
