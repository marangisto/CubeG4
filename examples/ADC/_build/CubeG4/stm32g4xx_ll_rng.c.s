  ...
  13              		.file	"stm32g4xx_ll_rng.c"
  14              		.text
  15              	.Ltext0:
  16              		.cfi_sections	.debug_frame
  17              		.section	.text.LL_RNG_DeInit,"ax",%progbits
  18              		.align	1
  19              		.global	LL_RNG_DeInit
  20              		.arch armv7e-m
  21              		.syntax unified
  22              		.thumb
  23              		.thumb_func
  ...
  27              	.LVL0:
  28              	.LFB189:
  29              		.file 1 "../../..\\CubeG4\\src\\stm32g4xx_ll_rng.c"
   1:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** /**
   2:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   ******************************************************************************
   3:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   * @file    stm32g4xx_ll_rng.c
   4:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   * @author  MCD Application Team
   5:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   * @brief   RNG LL module driver.
   6:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   ******************************************************************************
   7:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   * @attention
   8:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   *
   9:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   * <h2><center>&copy; Copyright (c) 2019 STMicroelectronics.
  10:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   * All rights reserved.</center></h2>
  11:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   *
  12:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   * This software component is licensed by ST under BSD 3-Clause license,
  13:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   * the "License"; You may not use this file except in compliance with the
  14:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   * License. You may obtain a copy of the License at:
  15:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   *                        opensource.org/licenses/BSD-3-Clause
  16:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   *
  17:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   ******************************************************************************
  18:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   */
  19:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** #if defined(USE_FULL_LL_DRIVER)
  20:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** 
  21:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** /* Includes ------------------------------------------------------------------*/
  22:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** #include "stm32g4xx_ll_rng.h"
  23:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** #include "stm32g4xx_ll_bus.h"
  24:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** 
  25:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** #ifdef  USE_FULL_ASSERT
  26:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** #include "stm32_assert.h"
  27:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** #else
  28:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** #define assert_param(expr) ((void)0U)
  29:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** #endif
  30:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** 
  31:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** /** @addtogroup STM32G4xx_LL_Driver
  32:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   * @{
  33:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   */
  34:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** 
  35:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** #if defined (RNG)
  36:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** 
  37:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** /** @addtogroup RNG_LL
  38:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   * @{
  39:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   */
  40:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** 
  41:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** /* Private types -------------------------------------------------------------*/
  42:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** /* Private variables ---------------------------------------------------------*/
  43:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** /* Private constants ---------------------------------------------------------*/
  44:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** /* Private macros ------------------------------------------------------------*/
  45:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** /** @addtogroup RNG_LL_Private_Macros
  46:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   * @{
  47:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   */
  48:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** #define IS_LL_RNG_CED(__MODE__) (((__MODE__) == LL_RNG_CED_ENABLE) || \
  49:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****                                  ((__MODE__) == LL_RNG_CED_DISABLE))
  50:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** 
  51:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** /**
  52:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   * @}
  53:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   */
  54:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** /* Private function prototypes -----------------------------------------------*/
  55:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** 
  56:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** /* Exported functions --------------------------------------------------------*/
  57:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** /** @addtogroup RNG_LL_Exported_Functions
  58:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   * @{
  59:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   */
  60:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** 
  61:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** /** @addtogroup RNG_LL_EF_Init
  62:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   * @{
  63:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   */
  64:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** 
  65:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** /**
  66:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   * @brief  De-initialize RNG registers (Registers restored to their default values).
  67:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   * @param  RNGx RNG Instance
  68:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   * @retval An ErrorStatus enumeration value:
  69:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   *          - SUCCESS: RNG registers are de-initialized
  70:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   *          - ERROR: not applicable
  71:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   */
  72:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** ErrorStatus LL_RNG_DeInit(RNG_TypeDef *RNGx)
  73:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** {
  30              		.loc 1 73 1 view -0
  31              		.cfi_startproc
  32              		@ args = 0, pretend = 0, frame = 0
  33              		@ frame_needed = 0, uses_anonymous_args = 0
  34              		@ link register save eliminated.
  74:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   /* Check the parameters */
  75:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   assert_param(IS_RNG_ALL_INSTANCE(RNGx));
  35              		.loc 1 75 3 view .LVU1
  76:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   /* Enable RNG reset state */
  77:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   LL_AHB2_GRP1_ForceReset(LL_AHB2_GRP1_PERIPH_RNG);
  36              		.loc 1 77 3 view .LVU2
  37              	.LBB6:
  38              	.LBI6:
  39              		.file 2 "../../..\\CubeG4\\include/stm32g4xx_ll_bus.h"
 ...
 583:../../..\CubeG4\include/stm32g4xx_ll_bus.h **** __STATIC_INLINE void LL_AHB2_GRP1_ForceReset(uint32_t Periphs)
  40              		.loc 2 583 22 view .LVU3
  41              	.LBB7:
 584:../../..\CubeG4\include/stm32g4xx_ll_bus.h **** {
 585:../../..\CubeG4\include/stm32g4xx_ll_bus.h ****   SET_BIT(RCC->AHB2RSTR, Periphs);
  42              		.loc 2 585 3 view .LVU4
  43 0000 054B     		ldr	r3, .L2
  44 0002 DA6A     		ldr	r2, [r3, #44]
  45 0004 42F08062 		orr	r2, r2, #67108864
  46 0008 DA62     		str	r2, [r3, #44]
  47              	.LVL1:
  48              		.loc 2 585 3 is_stmt 0 view .LVU5
  49              	.LBE7:
  50              	.LBE6:
  78:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** 
  79:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   /* Release RNG from reset state */
  80:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   LL_AHB2_GRP1_ReleaseReset(LL_AHB2_GRP1_PERIPH_RNG);
  51              		.loc 1 80 3 is_stmt 1 view .LVU6
  52              	.LBB8:
  53              	.LBI8:
 ...
 625:../../..\CubeG4\include/stm32g4xx_ll_bus.h **** __STATIC_INLINE void LL_AHB2_GRP1_ReleaseReset(uint32_t Periphs)
  54              		.loc 2 625 22 view .LVU7
  55              	.LBB9:
 626:../../..\CubeG4\include/stm32g4xx_ll_bus.h **** {
 627:../../..\CubeG4\include/stm32g4xx_ll_bus.h ****   CLEAR_BIT(RCC->AHB2RSTR, Periphs);
  56              		.loc 2 627 3 view .LVU8
  57 000a DA6A     		ldr	r2, [r3, #44]
  58 000c 22F08062 		bic	r2, r2, #67108864
  59 0010 DA62     		str	r2, [r3, #44]
  60              	.LVL2:
  61              		.loc 2 627 3 is_stmt 0 view .LVU9
  62              	.LBE9:
  63              	.LBE8:
  81:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   return (SUCCESS);
  64              		.loc 1 81 3 is_stmt 1 view .LVU10
  82:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** }
  65              		.loc 1 82 1 is_stmt 0 view .LVU11
  66 0012 0020     		movs	r0, #0
  67              	.LVL3:
  68              		.loc 1 82 1 view .LVU12
  69 0014 7047     		bx	lr
  70              	.L3:
  71 0016 00BF     		.align	2
  72              	.L2:
  73 0018 00100240 		.word	1073876992
  74              		.cfi_endproc
  75              	.LFE189:
  77              		.section	.text.LL_RNG_Init,"ax",%progbits
  78              		.align	1
  79              		.global	LL_RNG_Init
  80              		.syntax unified
  81              		.thumb
  82              		.thumb_func
  83              		.fpu fpv4-sp-d16
  ...
  86              	.LVL4:
  87              	.LFB190:
  83:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** 
  84:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** /**
  85:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   * @brief  Initialize RNG registers according to the specified parameters in RNG_InitStruct.
  86:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   * @param  RNGx RNG Instance
  87:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   * @param  RNG_InitStruct pointer to a LL_RNG_InitTypeDef structure
  88:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   *         that contains the configuration information for the specified RNG peripheral.
  89:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   * @retval An ErrorStatus enumeration value:
  90:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   *          - SUCCESS: RNG registers are initialized according to RNG_InitStruct content
  91:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   *          - ERROR: not applicable
  92:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   */
  93:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** ErrorStatus LL_RNG_Init(RNG_TypeDef *RNGx, LL_RNG_InitTypeDef *RNG_InitStruct)
  94:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** {
  88              		.loc 1 94 1 is_stmt 1 view -0
  89              		.cfi_startproc
  90              		@ args = 0, pretend = 0, frame = 0
  91              		@ frame_needed = 0, uses_anonymous_args = 0
  92              		@ link register save eliminated.
  95:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   /* Check the parameters */
  96:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   assert_param(IS_RNG_ALL_INSTANCE(RNGx));
  93              		.loc 1 96 3 view .LVU14
  97:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   assert_param(IS_LL_RNG_CED(RNG_InitStruct->ClockErrorDetection));
  94              		.loc 1 97 3 view .LVU15
  98:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** 
  99:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   /* Clock Error Detection configuration */
 100:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   MODIFY_REG(RNGx->CR, RNG_CR_CED, RNG_InitStruct->ClockErrorDetection);
  95              		.loc 1 100 3 view .LVU16
  96 0000 0368     		ldr	r3, [r0]
  97 0002 0A68     		ldr	r2, [r1]
  98 0004 23F00803 		bic	r3, r3, #8
  99 0008 1343     		orrs	r3, r3, r2
 100 000a 0360     		str	r3, [r0]
 101:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** 
 102:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   return (SUCCESS);
 101              		.loc 1 102 3 view .LVU17
 103:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** }
 102              		.loc 1 103 1 is_stmt 0 view .LVU18
 103 000c 0020     		movs	r0, #0
 104              	.LVL5:
 105              		.loc 1 103 1 view .LVU19
 106 000e 7047     		bx	lr
 107              		.cfi_endproc
 108              	.LFE190:
 110              		.section	.text.LL_RNG_StructInit,"ax",%progbits
 111              		.align	1
 112              		.global	LL_RNG_StructInit
 113              		.syntax unified
 114              		.thumb
 115              		.thumb_func
 116              		.fpu fpv4-sp-d16
 118              	LL_RNG_StructInit:
 119              	.LVL6:
 120              	.LFB191:
 104:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** 
 105:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** /**
 106:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   * @brief Set each @ref LL_RNG_InitTypeDef field to default value.
 107:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   * @param RNG_InitStruct pointer to a @ref LL_RNG_InitTypeDef structure
 108:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   *                       whose fields will be set to default values.
 109:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   * @retval None
 110:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   */
 111:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** void LL_RNG_StructInit(LL_RNG_InitTypeDef *RNG_InitStruct)
 112:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** {
 121              		.loc 1 112 1 is_stmt 1 view -0
 122              		.cfi_startproc
 123              		@ args = 0, pretend = 0, frame = 0
 124              		@ frame_needed = 0, uses_anonymous_args = 0
 125              		@ link register save eliminated.
 113:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   /* Set RNG_InitStruct fields to default values */
 114:../../..\CubeG4\src/stm32g4xx_ll_rng.c ****   RNG_InitStruct->ClockErrorDetection = LL_RNG_CED_ENABLE;
 126              		.loc 1 114 3 view .LVU21
 127              		.loc 1 114 39 is_stmt 0 view .LVU22
 128 0000 0023     		movs	r3, #0
 129 0002 0360     		str	r3, [r0]
 115:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** 
 116:../../..\CubeG4\src/stm32g4xx_ll_rng.c **** }
 130              		.loc 1 116 1 view .LVU23
 131 0004 7047     		bx	lr
 132              		.cfi_endproc
 133              	.LFE191:
 135              		.text
 136              	.Letext0:
 137              		.file 3 "c:\\program files (x86)\\gnu tools arm embedded\\8 2018-q4-major\\arm-none-eabi\\include\
 138              		.file 4 "c:\\program files (x86)\\gnu tools arm embedded\\8 2018-q4-major\\arm-none-eabi\\include\
 139              		.file 5 "../../..\\CubeG4\\include/core_cm4.h"
 140              		.file 6 "../../..\\CubeG4\\include/system_stm32g4xx.h"
 141              		.file 7 "../../..\\CubeG4\\include/stm32g431xx.h"
 142              		.file 8 "../../..\\CubeG4\\include/stm32g4xx.h"
 143              		.file 9 "../../..\\CubeG4\\include/stm32g4xx_ll_rng.h"
