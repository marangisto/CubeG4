  ...
  13              		.file	"stm32g4xx_ll_crs.c"
  14              		.text
  15              	.Ltext0:
  16              		.cfi_sections	.debug_frame
  17              		.section	.text.LL_CRS_DeInit,"ax",%progbits
  18              		.align	1
  19              		.global	LL_CRS_DeInit
  20              		.arch armv7e-m
  21              		.syntax unified
  22              		.thumb
  23              		.thumb_func
  ...
  26              	LL_CRS_DeInit:
  27              	.LFB217:
  28              		.file 1 "../../..\\CubeG4\\src\\stm32g4xx_ll_crs.c"
   1:../../..\CubeG4\src/stm32g4xx_ll_crs.c **** /**
   2:../../..\CubeG4\src/stm32g4xx_ll_crs.c ****   ******************************************************************************
   3:../../..\CubeG4\src/stm32g4xx_ll_crs.c ****   * @file    stm32g4xx_ll_crs.h
   4:../../..\CubeG4\src/stm32g4xx_ll_crs.c ****   * @author  MCD Application Team
   5:../../..\CubeG4\src/stm32g4xx_ll_crs.c ****   * @brief   CRS LL module driver.
   6:../../..\CubeG4\src/stm32g4xx_ll_crs.c ****   ******************************************************************************
   7:../../..\CubeG4\src/stm32g4xx_ll_crs.c ****   * @attention
   8:../../..\CubeG4\src/stm32g4xx_ll_crs.c ****   *
   9:../../..\CubeG4\src/stm32g4xx_ll_crs.c ****   * <h2><center>&copy; Copyright (c) 2019 STMicroelectronics.
  10:../../..\CubeG4\src/stm32g4xx_ll_crs.c ****   * All rights reserved.</center></h2>
  11:../../..\CubeG4\src/stm32g4xx_ll_crs.c ****   *
  12:../../..\CubeG4\src/stm32g4xx_ll_crs.c ****   * This software component is licensed by ST under BSD 3-Clause license,
  13:../../..\CubeG4\src/stm32g4xx_ll_crs.c ****   * the "License"; You may not use this file except in compliance with the
  14:../../..\CubeG4\src/stm32g4xx_ll_crs.c ****   * License. You may obtain a copy of the License at:
  15:../../..\CubeG4\src/stm32g4xx_ll_crs.c ****   *                        opensource.org/licenses/BSD-3-Clause
  16:../../..\CubeG4\src/stm32g4xx_ll_crs.c ****   *
  17:../../..\CubeG4\src/stm32g4xx_ll_crs.c ****   ******************************************************************************
  18:../../..\CubeG4\src/stm32g4xx_ll_crs.c ****   */
  19:../../..\CubeG4\src/stm32g4xx_ll_crs.c **** #if defined(USE_FULL_LL_DRIVER)
  20:../../..\CubeG4\src/stm32g4xx_ll_crs.c **** 
  21:../../..\CubeG4\src/stm32g4xx_ll_crs.c **** /* Includes ------------------------------------------------------------------*/
  22:../../..\CubeG4\src/stm32g4xx_ll_crs.c **** #include "stm32g4xx_ll_crs.h"
  23:../../..\CubeG4\src/stm32g4xx_ll_crs.c **** #include "stm32g4xx_ll_bus.h"
  24:../../..\CubeG4\src/stm32g4xx_ll_crs.c **** 
  25:../../..\CubeG4\src/stm32g4xx_ll_crs.c **** /** @addtogroup STM32G4xx_LL_Driver
  26:../../..\CubeG4\src/stm32g4xx_ll_crs.c ****   * @{
  27:../../..\CubeG4\src/stm32g4xx_ll_crs.c ****   */
  28:../../..\CubeG4\src/stm32g4xx_ll_crs.c **** 
  29:../../..\CubeG4\src/stm32g4xx_ll_crs.c **** #if defined(CRS)
  30:../../..\CubeG4\src/stm32g4xx_ll_crs.c **** 
  31:../../..\CubeG4\src/stm32g4xx_ll_crs.c **** /** @defgroup CRS_LL CRS
  32:../../..\CubeG4\src/stm32g4xx_ll_crs.c ****   * @{
  33:../../..\CubeG4\src/stm32g4xx_ll_crs.c ****   */
  34:../../..\CubeG4\src/stm32g4xx_ll_crs.c **** 
  35:../../..\CubeG4\src/stm32g4xx_ll_crs.c **** /* Private types -------------------------------------------------------------*/
  36:../../..\CubeG4\src/stm32g4xx_ll_crs.c **** /* Private variables ---------------------------------------------------------*/
  37:../../..\CubeG4\src/stm32g4xx_ll_crs.c **** /* Private constants ---------------------------------------------------------*/
  38:../../..\CubeG4\src/stm32g4xx_ll_crs.c **** /* Private macros ------------------------------------------------------------*/
  39:../../..\CubeG4\src/stm32g4xx_ll_crs.c **** /* Private function prototypes -----------------------------------------------*/
  40:../../..\CubeG4\src/stm32g4xx_ll_crs.c **** 
  41:../../..\CubeG4\src/stm32g4xx_ll_crs.c **** /* Exported functions --------------------------------------------------------*/
  42:../../..\CubeG4\src/stm32g4xx_ll_crs.c **** /** @addtogroup CRS_LL_Exported_Functions
  43:../../..\CubeG4\src/stm32g4xx_ll_crs.c ****   * @{
  44:../../..\CubeG4\src/stm32g4xx_ll_crs.c ****   */
  45:../../..\CubeG4\src/stm32g4xx_ll_crs.c **** 
  46:../../..\CubeG4\src/stm32g4xx_ll_crs.c **** /** @addtogroup CRS_LL_EF_Init
  47:../../..\CubeG4\src/stm32g4xx_ll_crs.c ****   * @{
  48:../../..\CubeG4\src/stm32g4xx_ll_crs.c ****   */
  49:../../..\CubeG4\src/stm32g4xx_ll_crs.c **** 
  50:../../..\CubeG4\src/stm32g4xx_ll_crs.c **** /**
  51:../../..\CubeG4\src/stm32g4xx_ll_crs.c ****   * @brief  De-Initializes CRS peripheral registers to their default reset values.
  52:../../..\CubeG4\src/stm32g4xx_ll_crs.c ****   * @retval An ErrorStatus enumeration value:
  53:../../..\CubeG4\src/stm32g4xx_ll_crs.c ****   *          - SUCCESS: CRS registers are de-initialized
  54:../../..\CubeG4\src/stm32g4xx_ll_crs.c ****   *          - ERROR: not applicable
  55:../../..\CubeG4\src/stm32g4xx_ll_crs.c ****   */
  56:../../..\CubeG4\src/stm32g4xx_ll_crs.c **** ErrorStatus LL_CRS_DeInit(void)
  57:../../..\CubeG4\src/stm32g4xx_ll_crs.c **** {
  29              		.loc 1 57 1 view -0
  30              		.cfi_startproc
  31              		@ args = 0, pretend = 0, frame = 0
  32              		@ frame_needed = 0, uses_anonymous_args = 0
  33              		@ link register save eliminated.
  58:../../..\CubeG4\src/stm32g4xx_ll_crs.c ****   LL_APB1_GRP1_ForceReset(LL_APB1_GRP1_PERIPH_CRS);
...
1143:../../..\CubeG4\include/stm32g4xx_ll_bus.h ****   SET_BIT(RCC->APB1RSTR1, Periphs);
  ...
  44 0004 42F48072 		orr	r2, r2, #256
  45 0008 9A63     		str	r2, [r3, #56]
  46              	.LVL1:
  47              		.loc 2 1143 3 is_stmt 0 view .LVU4
  48              	.LBE7:
  49              	.LBE6:
  59:../../..\CubeG4\src/stm32g4xx_ll_crs.c ****   LL_APB1_GRP1_ReleaseReset(LL_APB1_GRP1_PERIPH_CRS);
  50              		.loc 1 59 3 is_stmt 1 view .LVU5
  51              	.LBB8:
  52              	.LBI8:
...
1213:../../..\CubeG4\include/stm32g4xx_ll_bus.h ****   CLEAR_BIT(RCC->APB1RSTR1, Periphs);
  ...
  57 000c 22F48072 		bic	r2, r2, #256
  58 0010 9A63     		str	r2, [r3, #56]
  59              	.LVL2:
  60              		.loc 2 1213 3 is_stmt 0 view .LVU8
  61              	.LBE9:
  62              	.LBE8:
  60:../../..\CubeG4\src/stm32g4xx_ll_crs.c **** 
  61:../../..\CubeG4\src/stm32g4xx_ll_crs.c ****   return  SUCCESS;
  63              		.loc 1 61 3 is_stmt 1 view .LVU9
  62:../../..\CubeG4\src/stm32g4xx_ll_crs.c **** }
  64              		.loc 1 62 1 is_stmt 0 view .LVU10
